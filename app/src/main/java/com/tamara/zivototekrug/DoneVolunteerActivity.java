...
public class DoneVolunteerActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private FirebaseDatabase mDatabase = FirebaseDatabase.getInstance();
    private DatabaseReference root = mDatabase.getReference().child("HelpRequests");
    private doneVolAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_done_volunteer);
        ...
        list = new ArrayList<>();
        adapter = new doneVolAdapter(this, list);
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    if (helpRequest.getStatus().equals("Done") && helpRequest.getVolunteerEmail().equals(mEmail)){
