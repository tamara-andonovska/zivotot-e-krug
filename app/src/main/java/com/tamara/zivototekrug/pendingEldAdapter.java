...
public class pendingEldAdapter extends RecyclerView.Adapter<pendingEldAdapter.MyViewHolder> {
    ArrayList<HelpRequest> mList;
    Context context;

    public pendingEldAdapter(Context context, ArrayList<HelpRequest> mList) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public pendingEldAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.pending_requests_eld, parent, false);
        return new pendingEldAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull pendingEldAdapter.MyViewHolder holder, int position) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView description, emergencyLevel, type, loc, repeat, date, time, status, volName, volEmail, volPhone, volRating, id, volId;
        ...
        public MyViewHolder(@NonNull View itemView) {
                ...
                public void onClick(View view) {
                    ...
                    ref.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            String ratingStr = user.getRating();
                            String userIdStr = mUser.getUid();
                            ...
                            //ovde ne se prakja tocnotooo tuku se menja so id na elderly
                            String volIdStr = volId.getText().toString();
                            //Toast.makeText(view.getContext(), volIdStr, Toast.LENGTH_SHORT).show(); //okej si vlece posle toa

                            updateData(dateStr, descriptionStr, emailStr, emergencyLevelStr, typeStr, idStr,
                    ...
                    Toast.makeText(itemView.getContext(), "Successfully accepted the volunteer", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(itemView.getContext(), PendingEldActivity.class);
            ...
            btnReject.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(itemView.getContext(), "Successfully rejected the volunteer", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(itemView.getContext(), PendingEldActivity.class);
