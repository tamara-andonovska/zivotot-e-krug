...
public class AssignedVolunteerActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private FirebaseDatabase mDatabase = FirebaseDatabase.getInstance();
    private DatabaseReference root = mDatabase.getReference().child("HelpRequests");
    private assignedVolAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assigned_volunteer);
        ...
        list = new ArrayList<>();
        adapter = new assignedVolAdapter(this, list);
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    if (helpRequest.getStatus().equals("Assigned") && helpRequest.getVolunteerEmail().equals(mEmail)){
